...
const packages = [
  ...
  { name: "Pro", subtitle: "For established businesses", price: "$1499+", period: "/month", highlight: false, badge: "Best Value", description: "Full-service bookkeeping, payroll, tax planning, and monthly CFO strategy sessions.", features: ["Unlimited transactions","Full monthly bookkeeping","Payroll processing (unlimited employees)","Sales tax filing","Quarterly tax estimates","Tax planning & strategy","Monthly CFO advisory call","KPI dashboard setup","Dedicated senior accountant","Annual tax return preparation","24-hour response guarantee"], notIncluded: [], cta: "Get Started" },
];
        ...
        <div className="max-w-3xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+19494442271" className="font-semibold px-8 py-4 rounded-xl transition-all duration-200 text-sm border" style={{ fontFamily: "'DM Sans', sans-serif", color: 'rgba(255,200,200,0.9)', borderColor: 'rgba(200,16,46,0.4)', backgroundColor: 'transparent' }} onMouseEnter={e => { e.currentTarget.style.backgroundColor = 'rgba(200,16,46,0.15)'; e.currentTarget.style.borderColor = '#C8102E'; }} onMouseLeave={e => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.borderColor = 'rgba(200,16,46,0.4)'; }}>Call +1 (949) 444-2271</a>
            </div>
          </motion.div>
        </div>
      </section>
